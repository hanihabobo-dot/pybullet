...
(define (problem boxel-tamp-debug)
  ...
  (:init
    ...
    (obj_at_boxel_KIF target_2 free_054)
    (obj_at_boxel_KIF target_2 free_055)
    (obj_at_boxel_KIF target_2 free_056)
    (obj_at_boxel_KIF target_2 obj_006)
    (obj_at_boxel_KIF target_2 obj_007)
    (obj_at_boxel_KIF target_2 obj_008)
    (obj_at_boxel_KIF target_2 obj_009)
